...
class DeviceEvents(BaseModel):
    ...
    InitiatingProcessFileSize: Optional[int] = Field(None, description="Size in bytes of the file that ran the process responsible for the event.")
    ...
    RemoteDeviceName: Optional[str] = Field(None, description="Name of the device that performed a remote operation on the affected machine. Depending on the event being reported, this name could be a fully-qualified domain name (FQDN), a NetBIOS name, or a host name without domain information..")
