...
class DeviceTvmSecureConfigurationAssessment(BaseModel):
    ...
    Context: Optional[Any] = Field(
        None, description="Machine data configuration context"
    )
    ...
    IsApplicable: Optional[bool] = Field(
        None, description="Indicates whether the configuration or policy is applicable"
    )
    IsCompliant: Optional[bool] = Field(
        None,
        description="Indicates whether the configuration or policy is properly configured",
    )
    IsExpectedUserImpact: Optional[bool] = Field(
        None,
