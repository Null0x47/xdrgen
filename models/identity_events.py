...
class IdentityEvents(BaseModel):
    ...
    AccountId: Optional[str] = Field(
        None, description="Unique identifier for the account in the source application"
    )
    ...
    ActionFailureReason: Optional[str] = Field(
    ...
    TargetObjects: Optional[Any] = Field(
        None,
    ...
    Application: Optional[str] = Field(
        None, description="The source application where this event was received from"
    )
    ApplicationInstanceId: Optional[str] = Field(
        None, description="Domain of the source application"
    )
    ApplicationEventId: Optional[str] = Field(
        None, description="Raw event ID provided by the source application"
    )
    ApplicationSessionId: Optional[str] = Field(
        None, description="Raw session ID provided by the source application"
    )
    RawEventData: Optional[Any] = Field(
        None,
        description="Full raw event information from the source application in JSON format",
    )
