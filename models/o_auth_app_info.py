...
class OAuthAppInfo(BaseModel):
    ReportId: Optional[str] = Field(
        None, description="Unique identifier for the record"
    )
    Timestamp: Optional[datetime] = Field(
        None, description="Date and time when the record was created"
    )
    ...
    AddedOnTime: Optional[datetime] = Field(
        None, description="Date and time when the application was registered"
    )
    LastModifiedTime: Optional[datetime] = Field(
        None, description="Timestamp when the app was last modified"
    )
    AppStatus: Optional[str] = Field(
        None,
    ...
    VerifiedPublisher: Optional[Any] = Field(
        None,
    ...
    PrivilegeLevel: Optional[str] = Field(
        None,
    ...
    ConsentedUsersCount: Optional[int] = Field(
        None,
        description="Count of users who have consented to the app; this information is only available when the app isn't admin consented",
    )
    IsAdminConsented: Optional[bool] = Field(
        None,
    ...
    AppOrigin: Optional[str] = Field(
        None,
        description="Specifies whether the app is internal to the organization or registered in an external tenant",
    )
    LastUsedTime: Optional[datetime] = Field(
        None,
        description="Date and time when the app last signed in. Tracking of this data goes back to June, 2022",
    )
    AppOwnerTenantId: Optional[str] = Field(
        None, description="Specifies the ID of the tenant where the app was registered"
    )
