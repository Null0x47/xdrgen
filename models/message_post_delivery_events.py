...
class MessagePostDeliveryEvents(BaseModel):
    ...
    Action: Optional[str] = Field(
        None, description="Action taken on the message: Blocked, Moved to quarantine"
    )
    ...
    ActionTrigger: Optional[str] = Field(
        None,
    ...
    LatestDeliveryLocation: Optional[str] = Field(
        None, description="Last known location of the message"
    )
