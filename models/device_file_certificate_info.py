...
class DeviceFileCertificateInfo(BaseModel):
    CertificateCountersignatureTime: Optional[datetime] = Field(
        None, description="Date and time (UTC) the certificate was countersigned."
    )
    CertificateCreationTime: Optional[datetime] = Field(
        None, description="Date and time (UTC) the certificate was created."
    )
    CertificateExpirationTime: Optional[datetime] = Field(
        None, description="Certificate expiry date and time (UTC)."
    )
    ...
    CrlDistributionPointUrls: Optional[str] = Field(
        None,
    ...
    IsRootSignerMicrosoft: Optional[bool] = Field(
        None,
        description="Indicates whether the signer of the root certificate is Microsoft.",
    )
    IsSigned: Optional[bool] = Field(
        None, description="Indicates whether the file is signed."
    )
    Issuer: Optional[str] = Field(
        None, description="Information about the issuing certificate authority (CA)."
    )
    IssuerHash: Optional[str] = Field(
        None,
        description="Unique hash value identifying issuing certificate authority (CA).",
    )
    IsTrusted: Optional[bool] = Field(
        None,
    ...
    SignatureType: Optional[str] = Field(
        None,
    ...
    Signer: Optional[str] = Field(
        None, description="Information about the signer of the file."
    )
    SignerHash: Optional[str] = Field(
        None, description="Unique hash value identifying the signer."
    )
