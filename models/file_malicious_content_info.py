...
class FileMaliciousContentInfo(BaseModel):
    ...
    DocumentID: Optional[str] = Field(
        None, description="Unique identifier of the file."
    )
    FileCreationTime: Optional[datetime] = Field(
        None, description="Timestamp of the file creation."
    )
    FileName: Optional[str] = Field(
        None, description="Name of the file that the recorded action was applied to."
    )
    FileOwnerDisplayName: Optional[str] = Field(
        None, description="Account recorded as owner of the file."
    )
    FileOwnerUpn: Optional[str] = Field(
        None, description="Account recorded as owner of the file"
    )
    ...
    LastModifyingAccountUpn: Optional[str] = Field(
        None, description="Account that last modified this file."
    )
    ...
    ThreatNames: Optional[str] = Field(
        None, description="Detection name for malware or other threats found."
    )
