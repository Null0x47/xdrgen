...
class DeviceTvmSecureConfigurationAssessmentKB(BaseModel):
    ConfigurationBenchmarks: Optional[Any] = Field(
        None,
        description="List of industry benchmarks which recommend the same or similar configuration.",
    )
    ConfigurationCategory: Optional[str] = Field(
        None, description="Category or grouping to which the configuration belongs."
    )
    ConfigurationDescription: Optional[str] = Field(
        None, description="Description of the configuration."
    )
    ConfigurationId: Optional[str] = Field(
        None, description="Unique identifier for a specific configuration."
    )
    ConfigurationImpact: Optional[float] = Field(
        None,
    ...
    ConfigurationName: Optional[str] = Field(
        None, description="Display name of the configuration."
    )
    ConfigurationSubcategory: Optional[str] = Field(
        None,
    ...
    RelatedMitreTactics: Optional[Any] = Field(
        None, description="Related tactics from Mitre knowledge base."
    )
    RelatedMitreTechniques: Optional[Any] = Field(
        None, description="Related techniques from Mitre knowledge base."
    )
    RemediationOptions: Optional[str] = Field(
        None,
        description="Recommended actions to reduce or address any associated risks",
    )
    RiskDescription: Optional[str] = Field(
        None, description="Description of any associated risks."
    )
