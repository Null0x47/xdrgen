...
class DeviceBehaviorInfo(BaseModel):
    ...
    AttackTechniques: Optional[str] = Field(None, description="MITRE ATT&CK techniques associated with the activity that triggered the alert. Defined by the MITRE ATT&CK Matrix for Enterprise.")
