...
class UrlClickEvents(BaseModel):
    AccountUpn: Optional[str] = Field(
        None, description="User Principal Name of the account that clicked on the link."
    )
    ...
    AppVersion: Optional[str] = Field(
        None, description="Version of the client application where click occurred"
    )
    ...
    IsClickedThrough: Optional[bool] = Field(
        None,
    ...
    SourceId: Optional[str] = Field(
        None, description="Unique identifier for the source of the click"
    )
    ...
    Url: Optional[str] = Field(
        None, description="The full URL that was clicked on by the user."
    )
    UrlChain: Optional[str] = Field(
        None,
