...
class CloudProcessEvents(BaseModel):
    ...
    ContainerImageName: Optional[str] = Field(
        None, description="The container image name or ID, if it exists"
    )
    ...
    ActionType: Optional[str] = Field(
        None,
        description="Type of activity that triggered the event. See the in-portal schema reference for details.",
    )
    ...
    ParentProcessName: Optional[str] = Field(
        None, description="The name of the parent process"
    )
    ParentProcessId: Optional[str] = Field(
        None, description="The process ID (PID) of the parent process"
    )
    ...
    ProcessCurrentWorkingDirectory: Optional[str] = Field(
        None, description="Current working directory of the running process"
    )
    AccountName: Optional[str] = Field(None, description="User name of the account")
    LogonId: Optional[int] = Field(
        None,
        description="Identifier for a logon session. This identifier is unique on the same pod or container between restarts.",
    )
    InitiatingProcessId: Optional[str] = Field(
