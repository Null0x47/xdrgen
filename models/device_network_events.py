...
class DeviceNetworkEvents(BaseModel):
    ...
    InitiatingProcessFileSize: Optional[int] = Field(
        None,
        description="Size of the file (bytes) that ran the process responsible for the event.",
    )
    ...
    LocalIPType: Optional[str] = Field(
        None,
    ...
    Protocol: Optional[str] = Field(
        None, description="IP protocol used, whether TCP or UDP."
    )
