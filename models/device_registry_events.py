...
class DeviceRegistryEvents(BaseModel):
    ...
    InitiatingProcessAccountDomain: Optional[str] = Field(
        None, description="Domain of the account that ran the initiating process."
    )
    InitiatingProcessAccountName: Optional[str] = Field(
        None, description="User name of the account that ran the initiating process."
    )
    InitiatingProcessAccountObjectId: Optional[str] = Field(
        None,
        description="Azure AD object ID of the user account that ran the initiating process.",
    )
    InitiatingProcessAccountSid: Optional[str] = Field(
        None,
        description="Security Identifier (SID) of the account that ran the initiating process.",
    )
    InitiatingProcessAccountUpn: Optional[str] = Field(
        None,
        description="User principal name (UPN) of the account that ran the initiating process.",
    )
    InitiatingProcessCommandLine: Optional[str] = Field(
        None, description="Command line used to run the initiating process."
    )
    ...
    InitiatingProcessFileName: Optional[str] = Field(
        None, description="Name of the initiating process."
    )
    ...
    InitiatingProcessFolderPath: Optional[str] = Field(
        None, description="Folder containing the initiating process (image file)."
    )
    InitiatingProcessId: Optional[int] = Field(
        None, description="Process ID (PID) of the initiating process."
    )
    InitiatingProcessIntegrityLevel: Optional[str] = Field(
        None,
        description="Integrity level of the initiating process. Windows assigns integrity levels to processes based on certain characteristics, such as if they were launched from an internet download. These integrity levels influence permissions to resources..",
    )
    InitiatingProcessMD5: Optional[str] = Field(
        None, description="MD5 hash of the initiating process (image file)."
    )
    ...
    InitiatingProcessParentFileName: Optional[str] = Field(
        None,
        description="Name of the parent process that spawned the initiating process.",
    )
    InitiatingProcessParentId: Optional[int] = Field(
        None,
        description="Process ID (PID) of the parent process that spawned the initiating process.",
    )
    ...
    InitiatingProcessSHA1: Optional[str] = Field(
        None, description="SHA-1 hash of the initiating process (image file)."
    )
    InitiatingProcessSHA256: Optional[str] = Field(
        None,
        description="SHA-256 hash of the initiating process (image file). In some cases this column may not be populated - please use the InitiatingProcessSHA1 column instead.",
    )
    InitiatingProcessTokenElevation: Optional[str] = Field(
        None,
        description="Token type indicating the presence or absence of User Access Control (UAC) privilege elevation applied to the initiating process.",
    )
    ...
    PreviousRegistryKey: Optional[str] = Field(
        None, description="Original registry key before it was modified."
    )
    PreviousRegistryValueData: Optional[str] = Field(
        None, description="Original data of the registry value before it was modified."
    )
    PreviousRegistryValueName: Optional[str] = Field(
        None, description="Original name of the registry value before it was modified."
    )
    ...
    RegistryValueType: Optional[str] = Field(
        None,
