...
class CloudPolicyEnforcementEvents(BaseModel):
    ...
    DataSource: Optional[str] = Field(
        None,
        description="Data source of the cloud events; possible values: Google Kubernetes Engine, Elastic Kubernetes Service, or Azure Kubernetes Service",
    )
    ...
    ActionType: Optional[str] = Field(
        None,
        description="Type of activity that resulted from the policy enforcement operation; possible values: Audit, Deny, or Allow",
    )
    AzureResourceId: Optional[str] = Field(
        None,
        description="Unique identifier of the Azure resource associated with the event",
    )
    ...
    Region: Optional[str] = Field(
        None, description="The region associated with the Kubernetes cluster"
    )
    ResourceKind: Optional[str] = Field(
        None,
        description="Type or kind of Kubernetes resource created or managed (for example, pod or deployment)",
    )
    ResourceName: Optional[str] = Field(
        None, description="Name of the Kubernetes resource"
    )
    KubernetesNamespace: Optional[str] = Field(
        None, description="The Kubernetes namespace name"
    )
    Reason: Optional[str] = Field(
        None, description="Information explaining the action result"
    )
