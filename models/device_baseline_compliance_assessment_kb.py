...
class DeviceBaselineComplianceAssessmentKB(BaseModel):
    ...
    ConfigurationRationale: Optional[str] = Field(
        None,
    ...
    ConfigurationBenchmark: Optional[str] = Field(
        None, description="Industry benchmark recommending the configuration"
    )
    Source: Optional[Any] = Field(
        None,
        description="The registry path or other location used to determine the current device setting",
    )
    RecommendedValue: Optional[Any] = Field(
        None,
