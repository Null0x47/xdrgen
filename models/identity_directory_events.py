...
class IdentityDirectoryEvents(BaseModel):
    AccountDisplayName: Optional[str] = Field(
        None, description="Name of the account user displayed in the address book"
    )
    ...
    DestinationDeviceName: Optional[str] = Field(
        None,
    ...
    DestinationPort: Optional[str] = Field(
        None, description="Destination port of related network communications"
    )
