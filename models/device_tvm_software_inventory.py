...
class DeviceTvmSoftwareInventory(BaseModel):
    ...
    EndOfSupportStatus: Optional[str] = Field(None, description="Indicates the lifecycle stage of the software product relative to its specified end-of-support (EOS) or end-of-life (EOL) date")
    ...
    ProductCodeCpe: Optional[str] = Field(None, description="The standard Common Platform Enumeration (CPE) name of the software product version")
