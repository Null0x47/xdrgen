...
class EmailUrlInfo(BaseModel):
    NetworkMessageId: Optional[str] = Field(
        None, description="Email unique identifier generated by Office 365"
    )
    ...
    Url: Optional[str] = Field(
        None, description="Information about URLs on Office 365 emails"
    )
    UrlDomain: Optional[str] = Field(None, description="Domain part of the Url")
    UrlLocation: Optional[str] = Field(
        None, description="Indicates which part of the email the URL is located"
    )
