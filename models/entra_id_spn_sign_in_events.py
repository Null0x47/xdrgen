...
class EntraIdSpnSignInEvents(BaseModel):
    ...
    IsManagedIdentity: Optional[bool] = Field(
        None,
    ...
    CorrelationId: Optional[str] = Field(
        None, description="Unique identifier of the sign-in event"
    )
    ServicePrincipalName: Optional[str] = Field(
        None, description="Name of the service principal that initiated the sign-in"
    )
