...
class DeviceTvmSoftwareEvidenceBeta(BaseModel):
    ...
    SoftwareVendor: Optional[str] = Field(
        None, description="Name of the software publisher"
    )
    ...
    LastSeenTime: Optional[str] = Field(
        None, description="Date and time when the device was last seen by this service"
    )
