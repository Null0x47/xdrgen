...
class DeviceTvmInfoGatheringKB(BaseModel):
    IgId: Optional[str] = Field(
        None, description="Unique identifier for the piece of information gathered"
    )
    ...
    Description: Optional[str] = Field(
        None, description="Description of the information gathered"
    )
    Categories: Optional[Any] = Field(
        None,
        description="List of categories that the information belongs to, in JSON array format",
    )
    DataStructure: Optional[str] = Field(
        None, description="The data structure of the information gathered"
    )
