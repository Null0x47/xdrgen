...
class CloudDnsEvents(BaseModel):
    ...
    KubernetesResource: Optional[str] = Field(
        None,
    ...
    KubernetesNamespace: Optional[str] = Field(
        None, description="The Kubernetes namespace name"
    )
    KubernetesPodName: Optional[str] = Field(
        None, description="The Kubernetes pod name"
    )
    ...
    ProcessName: Optional[str] = Field(
        None, description="The name of the process that initiated the DNS query"
    )
    ProcessId: Optional[int] = Field(
        None, description="Process ID that initiated the DNS query"
    )
    DnsEventType: Optional[str] = Field(
        None,
        description="Type of event associated with DNS operation (for example, query)",
    )
    DnsEventSubType: Optional[str] = Field(
        None, description="Either request or response"
    )
    DnsQuery: Optional[str] = Field(
        None, description="The domain that needs to be resolved"
    )
    DnsQueryTypeName: Optional[str] = Field(
        None,
        description="The DNS resource record type name as defined by the Internet Assigned Numbers Authority (IANA)",
    )
    DnsResponseCodeName: Optional[str] = Field(
        None,
        description="The DNS response code name as defined by the Internet Assigned Numbers Authority (IANA).",
    )
    DnsNetworkDuration: Optional[int] = Field(
        None, description="The DNS request duration in milliseconds"
    )
    TransactionIdHex: Optional[str] = Field(
        None, description="The DNS unique hex transaction ID"
    )
