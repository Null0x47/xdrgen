...
class DeviceBehaviorEntities(BaseModel):
    ...
    DetailedEntityRole: Optional[str] = Field(
        None, description="The role of the entity in the behavior"
    )
    ...
    EmailClusterId: Optional[str] = Field(
        None,
    ...
    EntityRole: Optional[str] = Field(
        None, description="Indicates whether the entity is impacted or merely related."
    )
    ...
    OAuthApplicationId: Optional[str] = Field(
        None,
    ...
    ThreatFamily: Optional[str] = Field(
        None,
