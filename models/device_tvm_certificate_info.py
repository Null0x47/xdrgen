...
class DeviceTvmCertificateInfo(BaseModel):
    ...
    Thumbprint: Optional[str] = Field(
        None, description="Unique identifier for the certificate"
    )
    ...
    IssueDate: Optional[str] = Field(
        None, description="The earliest date and time when the certificate became valid"
    )
    SubjectType: Optional[str] = Field(
        None,
        description="Indicates if the holder of the certificate is a CA or end entity",
    )
    KeyUsage: Optional[str] = Field(
        None, description="The valid cryptographic uses of the certificate's public key"
    )
    ExtendedKeyUsage: Optional[str] = Field(
        None, description="Other valid uses for the certificate"
    )
