...
class DeviceTvmSoftwareVulnerabilitiesKB(BaseModel):
    AffectedSoftware: Optional[Any] = Field(
        None, description="List of all software products affected by the vulnerability."
    )
    ...
    IsExploitAvailable: Optional[bool] = Field(
        None,
    ...
    PublishedDate: Optional[datetime] = Field(
        None, description="Date vulnerability was disclosed to the public."
    )
    ...
    VulnerabilityDescription: Optional[str] = Field(
        None, description="Description of the vulnerability and associated risks."
    )
    VulnerabilitySeverityLevel: Optional[str] = Field(
        None,
