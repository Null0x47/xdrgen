...
class DeviceTvmHardwareFirmware(BaseModel):
    ...
    ComponentType: Optional[str] = Field(
        None, description="Type of hardware or firmware component"
    )
    Manufacturer: Optional[str] = Field(
        None, description="Manufacturer of hardware or firmware component"
    )
    ComponentName: Optional[str] = Field(
        None, description="Name of hardware or firmware component"
    )
    ComponentFamily: Optional[str] = Field(
        None,
    ...
    ComponentVersion: Optional[str] = Field(
        None, description="Component version (for example, BIOS version)"
    )
